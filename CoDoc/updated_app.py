...
load_dotenv(dotenv_path=os.getenv('GOOGLE_API_KEY_ENV', 'api_key.env'))
...
# Load environment variables from .env file in the script's directory or current working directory
load_dotenv()
